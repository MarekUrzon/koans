...
class AboutMessagePassing < Neo::Koan
  ...
  def test_send_with_underscores_will_also_send_messages
    ...
    # Answer:
    # https://stackoverflow.com/questions/4658269/ruby-send-vs-send?answertab=active#tab-top
    ...
    # If there were only __send__ the name send could be used by other classes without any confusion.
  ...
  def test_explicitly_implementing_respond_to_lets_objects_tell_the_truth
    ...
    assert catcher.respond_to?(:foo_bar)
